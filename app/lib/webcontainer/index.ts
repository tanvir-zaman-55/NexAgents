...
if (!import.meta.env.SSR) {
  ...
  if (!shouldBootWebcontainer) {
    console.error('❌ WebContainer cannot boot:', {
      crossOriginIsolated: window.crossOriginIsolated,
      experience,
      userAgent: navigator.userAgent,
    });
    console.error('Your browser does not support WebContainers. Please use Chrome, Edge, or Firefox (not Safari).');
  } else {
    console.log('✅ WebContainer can boot:', {
      crossOriginIsolated: window.crossOriginIsolated,
      experience,
    });
  }
