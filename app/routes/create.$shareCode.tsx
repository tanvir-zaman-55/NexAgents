...
export const meta: MetaFunction = () => {
  return [
    { title: 'Shared with NexAgents' },
    {
      name: 'description',
      content:
        'Someone shared with you a project created with NexAgents, the full-stack AI coding agent powered by Convex',
    },
    {
      property: 'og:image',
      ...
      <div className="flex min-h-screen flex-col items-center justify-center p-4">
        <div className="w-full max-w-md space-y-6 rounded-xl border bg-white p-8">
          <div className="space-y-2 text-center">
            <h1 className="text-center text-3xl font-bold">Sign in to NexAgents</h1>
            <p className="text-base text-gray-500">
              Please sign in to NexAgents to clone this project
