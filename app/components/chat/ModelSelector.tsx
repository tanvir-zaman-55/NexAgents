...
const providerToIcon: Record<string, React.ReactNode> = {
  ...
  openrouter: (
    <svg width="16" height="16" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256 256-114.6 256-256S397.4 0 256 0zm0 464c-114.9 0-208-93.1-208-208S141.1 48 256 48s208 93.1 208 208-93.1 208-208 208z"
        fill="currentColor"
      />
    ...
    <div className="flex items-center gap-2">
      <Combobox
        ...
        setSelectedOption={(option) => {
          ...
          const newModel = models[option as ModelSelection];
          if (newModel?.provider === 'openrouter') {
      ...
      />
      {(isOpenRouter || showCustomModelInput) && setCustomModel && (
        <div className="flex items-center gap-2">
          <TextInput
            type="text"
            value={customModel || ''}
            ...
            className="w-64"
          />
          <Tooltip tip="Enter an OpenRouter model ID. See openrouter.ai/models for available models.">
