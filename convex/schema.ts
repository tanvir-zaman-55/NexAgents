...
export default defineSchema({
  ...
  slackMessages: defineTable({
    ...
    .index("byChannel", ["channelId", "createdAt"])
    .searchIndex("search_content", {
      searchField: "content",
      filterFields: ["channelId"],
    }),

  // Education feature tables
  ...
  studentProjects: defineTable({
    ...
    .index("byCategory", ["category", "createdAt"])
    .index("byFeatured", ["featured", "createdAt"])
    .index("byComplexity", ["complexity"])
  ...
  classrooms: defineTable({
    ...
    studentIds: v.array(v.id("convexMembers")),
    createdAt: v.number(),
  ...
  challenges: defineTable({
    ...
    bonusFeatures: v.array(v.string()),
    month: v.string(),
    year: v.number(),
    featured: v.boolean(),
    prize: v.string(),
  ...
  challengeSubmissions: defineTable({
    ...
    winner: v.boolean(),
  }).index("byChallenge", ["challengeId", "submittedAt"]),
});
